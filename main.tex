...
% [自动生成] 生成摘要页 修改 Main_Miscellaneous/abstract_chs/eng.tex 中的内容
% [Auto Generate] Abstract, Rewrite your content in Main_Miscellaneous/abstract_chs/eng.tex
\thesisabstract
...
% [Auto Generate] Glossaries Page, Rewrite your content in Main_Miscellaneous/glossary.tex
\thesisglossarylist
...
% [Auto Generate] Reviewer List, set two number
\thesisreviewers{7}{5}
